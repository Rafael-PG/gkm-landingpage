...
interface PageHeroDefaultProps {
  kicker?: string;
  title: string;
  description?: string;
...
export default function PageHeroDefault({
  ...
  description,
  breadcrumbs,
}: PageHeroDefaultProps) {
  return (
    <section className="relative bg-brand-dark overflow-hidden">
      <div className="absolute inset-0 opacity-[0.03] bg-[linear-gradient(to_right,#808080_1px,transparent_1px),linear-gradient(to_bottom,#808080_1px,transparent_1px)] bg-[size:40px_40px]" />

      <div className="absolute top-1/3 left-1/2 w-[500px] md:w-[800px] h-[300px] md:h-[500px] bg-brand-red/5 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2 pointer-events-none" />
